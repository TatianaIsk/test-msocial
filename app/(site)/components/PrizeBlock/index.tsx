  ...
  <>
    <div className={s.wrapper}>
      ...
      <div className={s.redFrame}>
        <img srcSet={redFrame.src + ' 768w, ' + redFrameVert.src + ' 1200w'} alt='' sizes='(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw' className={s.imgRed} />
      </div>
      <div className={s.whiteFrame}>
        <img srcSet={whiteFrame.src + ' 768w, ' + whiteFrameVert.src + ' 1200w'} alt='' sizes='(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw' className={s.imgWhite}/>
      </div>
